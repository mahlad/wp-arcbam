<div class="bottom" style="background-image:url('<?php bloginfo('template_url'); ?>/images/footer-bg.png')">
	...
	<nav class="right">
		<ul>
			...
			<li class="learn left" style="background-image:url(<?php bloginfo('template_url'); ?>/images/maghalat.png)"><a href=" http://localhost/mahlad-wp-arcbam/learning/آموزش/ ‎" title="">آموزش</a> </li>
